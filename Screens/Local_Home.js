...
export default function Local_Home({ navigation }) {
  ...
  const menuTab = [{ title: 'الكل', selected: false }, { title: 'مرفوضة ', selected: false }, { title: 'مقبولة', selected: false }];
                ...
                <View key={index}>
                  <TouchableOpacity
                    ...
                    style={[styles.headerTab, {
                      backgroundColor: selectedMenu == index ? '#d9d9d9' : '#f1f1f1'
                    }]}>
                    <Text style={[text.themeDefault, text.text20]}>{menu?.title}</Text>
                  </TouchableOpacity>
          ...
          <Modal isVisible={isModalVisibleAccepted}>
            <View style={[styles.modalView]}>
              <View style={[styles.main]}>
                ...
                >
                  <View style={{}}>
                    <Button title="قبول" onpress={toggleModalAccepted}
                      style={{ backgroundColor: '#80cc28' }}
                    />
                  </View>
                  <View style={{}}>
                    <Button title="الغاء" onpress={toggleModalAccepted}
          ...
          <Modal isVisible={isModalVisibleRejected}>
            <View style={[styles.modalView]}>
              <View style={[styles.main]}>
                ...
                >
                  <View style={{}}>
                    <Button title="رفض" onpress={toggleModalRejected}
                      style={{ backgroundColor: '#c6302c' }}
                    />
                  </View>
                  <View style={{}}>
                    <Button title="الغاء" onpress={toggleModalRejected}
                      style={{ backgroundColor: '#a5d5db' }}
                    />
                  </View>
                </View>
