...
var AutoScrolling = function (_a) {
    ...
    return (React.createElement(react_native_1.View, { onLayout: measureContainerView, style: style },
        React.createElement(react_native_1.ScrollView, { horizontal: true, bounces: false, scrollEnabled: false, showsHorizontalScrollIndicator: false },
            React.createElement(react_native_1.Animated.View, { style: [
                ...
                isAutoScrollEnabled && (React.createElement(React.Fragment, null,
                    React.createElement(react_native_1.View, { style: { width: dividerWidth } }),
                    children))))));
};
